      ...
      <div className={styles.receiptWrapper}>
        <div className={styles.receiptHero}>
          <h2 className={styles.receiptTitle}>
            <span className={styles.receiptHighlight}>$49.50</span> in savings found!
          </h2>
          ...
          <div className={styles.receipt}>
            ...
            <div className={`${styles.receiptItem} ${styles.receiptItemSavings}`}>
              ...
              <div className={styles.savingsRow}>
                ...
                <span className={styles.savingsPrice}>$2.49</span>
              </div>
            </div>
